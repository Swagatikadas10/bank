...
function App() {
  ...
  <div className='bg-white p-6 rounded shadow-md'>
    ...
    <p className='text-gray-600'>
      Start saving for your goals with our flexible and rewarding personal
      savings accounts.
    </p>
  </div>
  ...
  <div className='bg-white p-6 rounded shadow-md'>
    ...
    <p className='text-gray-600'>
      Explore investment options and create a plan tailored to your financial
      aspirations.
    </p>
  </div>
  ...
  <div className='bg-white p-6 rounded shadow-md'>
    ...
    <p className='text-gray-600'>
      Achieve homeownership with our flexible and affordable home loan solutions.
    </p>
  </div>
</div>
    </section>
